...
2. **Barrau2012** (Becker) : cái này để test sự thay đổi của diffusion coefficients, nghiệm cũng phụ thuộc vào k.
3. **Carraro2016** : On the implementation of the xfem for interface problems. Cái này nghiệm rất đơn giản.
4. **Capatina2015** : cái này có áp dụng ghost penalty nhưng có khác tí, cái ví dụ nêu rõ luôn các hệ số lấy bao nhiêu, bao gồm cả $\lambda$
4. **Chopp2007** : ví dụ đơn giản, hệ có liên quan đến biofilm và potential.
5. **Barrau2013** : trong thèse của bà này có 2 ví dụ, có nói cụ thể. Thật ra mấy cái ví dụ trong đây cũng lấy từ cái khác nhưng mà áp dụng phoưng pháp trong này.
6. **Li2003** : lại là cái ví dụ $r=\sqrt{x^2+y^2}$.
7. **El-Otmany2015** : thesis của anh này nói khá rõ, có nhiều ví dụ, tiếng Pháp.
