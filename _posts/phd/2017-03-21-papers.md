...
`analysis of xfem 2008.pdf` có nói về cách xử lý trường hợp vết cắt quá nhỏ dẫn tới ill conditioned. Cái này cũng được nhắc đến trong bài báo của Hansbo và Burman nhưng mấy ông này dùng biện pháp Ghost penalty.
...
- Ổng "use the notation" $\Vert u\Vert\_{m,\Omega\_1\cup\Omega\_2} = \Vert u\Vert\_{m,\Omega\_2}^2 + \Vert u\Vert\_{m,\Omega\_2}^2$
