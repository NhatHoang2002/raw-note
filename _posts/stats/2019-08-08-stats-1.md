...
- Book: **[Understandable Statistics](https://books.google.fr/books?id=a8OiAgAAQBAJ&printsec=frontcover&dq=understandable+statistics&hl=en&sa=X&ved=0ahUKEwiR9-2n0YTkAhWnRBUIHQODDa0Q6AEIMTAB#v=onepage&q=understandable%20statistics&f=false)**- Brase Brase BOOK.pdf
...
![Illustration of Central Limit Theorem]({{img-url}}/IllustrationCentralTheorem.png){:.w-750}
...
**[??]**{:.tred} *How large should the sample sizebe if we want to apply the central limit theorem?* $\Rightarrow$ <mark>$n\ge 30$</mark> nhưng đừng dùng nó mù quáng! (ref. Theorem 7.2 of book *Understandable Statistics*)
...
### Confidence interval & uncertainly
