...
**[??]**{:.tred} *Nếu X là 1 RV, vậy $X^2$ có thể được hiểu thế nào? Lấy ví dụ?* / *Multiplication of two random variable?*
...
**[??]**{:.tred} *Dấu hiệu nhận biết của normal distribution là gì?*
...
**[??]**{:.tred} *Ví dụ của một X không có normal distribution nhưng converge về ND?*: [[1]](https://brilliant.org/wiki/central-limit-theorem/)
